...
def run_pipeline(tickers: List[str], start_date: str, end_date: str, load_ticker:bool=True, load_metadata:bool=True):
    """
    ...
    if load_metadata:
        all_meta = []
        for t in tickers:
            meta = downloader.fetch_ticker_metadata(t)
            all_meta.append(meta)
        manager.save_metadata(all_meta)
